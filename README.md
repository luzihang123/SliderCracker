...
``` shell script
    ...
    * 有无法破解的验证码、登陆校验或者加密参数校验等, 可以 issue 留言或者邮件/qq交流, 我会尝试破解, 但是不保证破解成功, 大家一起交流学习! <br>
    * 如果本项目帮助到了您, 请您给个 Star, 感谢!<br>
    ps: 有人跟我说腾讯系滑块没有轨迹校验, 只需要 ans 缺口距离和 cdata 验证通过时间即可, 我尝试过了, 但是并没有成功, 不知道是哪里的问题, 感兴趣的小伙伴可以尝试下! (轨迹加密校验应该是在setData()方法加载了所有的验证相关参数, 最后getData()方法生成了bcddef参数提交校验)<br>
```
